<?php  //This file is used for cheching the aggregate sales and profit of the products.
...
$db_server = mysql_connect($db_hostname, $db_username, $db_password);
 ...
 $proQuery = "SELECT SUM(quantity), SUM(price) from Invoice, Product where name = $proName";
